...
### 1️⃣ نمای کلی سفارش‌ها و تحقق درآمدها
...
### 2️⃣ کارایی کاتالوگ و تمرکز تجاری
...
### 3️⃣ چرخه سفارش تا نقدینگی و کارایی تبلیغات
...
<div dir="rtl" align="center">
  <table style="width: 100%; border-collapse: collapse; text-align: right; border: 1px solid #ddd;">
    ...
    <tbody>
      ...
      <tr>
      <td style="padding: 10px; border: 1px solid #ddd;">تنها ۲۲.۴۱٪ از کل درآمد از سفارش‌های تحویل‌شده حاصل شده است</td>
      <td style="padding: 10px; border: 1px solid #ddd;">با وجود تقاضای بالا، تنها بخش کوچکی از درآمد ثبت‌شده از طریق سفارش‌های تحویل‌شده محقق شده است</td>
      <td style="padding: 10px; border: 1px solid #ddd;">نشان‌دهنده یک چالش عملیاتی قابل‌توجه در تبدیل درآمد ثبت‌شده به درآمد محقق‌شده است</td>
      </tr>
      <tr>
      <td style="padding: 10px; border: 1px solid #ddd;">سفارش‌های ارسال‌شده توسط آمازون با تأخیر شدید در تحویل مواجه هستند</td>
      <td style="padding: 10px; border: 1px solid #ddd;">Amazon Fulfilment گلوگاه اصلی در تحقق درآمد است</td>
      <td style="padding: 10px; border: 1px solid #ddd;">عملکرد Fulfilment مهم‌ترین ریسک عملیاتی شناسایی‌شده در تحلیل است</td>
      </tr>
      <tr>
        <td style="padding: 10px; border: 1px solid #ddd;">سفارش‌های ارسال‌شده توسط فروشنده نرخ تحویل ۷۳.۶۸٪ دارند</td>
        <td style="padding: 10px; border: 1px solid #ddd;">ارسال توسط فروشنده عملکرد بهتری از نظر سفارش‌های تحویل‌شده دارد</td>
        <td style="padding: 10px; border: 1px solid #ddd;">می‌توان از عملکرد ارسال فروشنده به‌عنوان بنچمارک عملیاتی استفاده کرد</td>
      </tr>
      <tr>
...
- **درآمد تحقق‌نیافته از سفارش‌های Amazon-fulfilled:** ۵۷.۹ میلیون INR (حدود ۶۹.۶٪ از کل درآمد)

۶۲.۱۲٪ از کل درآمد مربوط به سفارش‌های در جریان (In-Progress) است و به سطح بالای درآمد تحقق‌نیافته کمک می‌کند.
...
- **کارایی تبلیغات:** تخفیف‌ها حجم سفارش را به‌طور قابل‌توجهی افزایش می‌دهند، اما افزایش محدودی در ارزش سبد خرید ایجاد می‌کنند (افزایش AOV تنها ۱.۱۷ برابر است). پیشنهاد می‌شود استراتژی قیمت‌گذاری به سمت رویکرد ارزش‌محور حرکت کند.
